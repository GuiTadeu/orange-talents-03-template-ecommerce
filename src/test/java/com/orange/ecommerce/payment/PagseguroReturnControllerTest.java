...
import static com.orange.ecommerce.payment.PaymentMethod.PAGSEGURO;
import static com.orange.ecommerce.payment.PaymentStatus.*;
import static com.orange.ecommerce.payment.PaymentStatus.STARTED;
import static org.junit.jupiter.api.Assertions.assertEquals;

@SpringBootTest
@AutoConfigureMockMvc
public class PagseguroReturnControllerTest {
    ...
    private ProductBuy pagseguroProductBuy;
    ...
    void setup() throws Exception {
        ...
        pagseguroProductBuy = saveProductBuy("Nespresso",
                "kratos@gmail.com", "kratos123", PAGSEGURO);
    }
    ...
    public void productPurchasedReturn__create_new_transaction_should_return_gatewayStatus_success_and_altered_payment_status_to_paid() throws Exception {
        assertEquals(pagseguroProductBuy.getStatus(), STARTED);
        login("atreus@gmail.com", "atreus123", "ROLE_CUSTOMER");

        URI paymentReturnUrl = new URI("/gateway/pagseguro/productBuy/" + pagseguroProductBuy.getId() + "/return");
        ...
        assertEquals(PAGSEGURO, lastPaymentTransaction.getPaymentMethod());
